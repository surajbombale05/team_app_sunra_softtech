...
class ClosedDealWidgetScreen extends StatefulWidget {
  const ClosedDealWidgetScreen({super.key});

  @override
  State<ClosedDealWidgetScreen> createState() => _ClosedDealWidgetScreenState();
}

class _ClosedDealWidgetScreenState extends State<ClosedDealWidgetScreen> {
